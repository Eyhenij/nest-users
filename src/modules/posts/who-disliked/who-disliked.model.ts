...
@Table({ timestamps: false, freezeTableName: true, tableName: 'whoDisliked' })
export class WhoDislikedModel extends Model {
	...
	@BelongsTo(() => Post, { as: 'whoDisliked', onDelete: 'CASCADE' })
	post: Post;
}
